var tinyMCEPreInit = { settings : { themes : "advanced", plugins : "safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage,-style,-emotions,-print,-searchreplace,-xhtmlxtras,-advlink,-advimage", languages : "en", debug : false }, base : "http://www.burgoblog.com/wp-includes/js/tinymce", suffix : "", query : "ver=311" };tinyMCEPreInit.start = function() {
...
tinymce.PluginManager.load("style", "http://www.burgoblog.com/wp-content/plugins/tinymce-advanced/mce/style/editor_plugin.js");
tinymce.PluginManager.load("emotions", "http://www.burgoblog.com/wp-content/plugins/tinymce-advanced/mce/emotions/editor_plugin.js");
tinymce.PluginManager.load("print", "http://www.burgoblog.com/wp-content/plugins/tinymce-advanced/mce/print/editor_plugin.js");
tinymce.PluginManager.load("searchreplace", "http://www.burgoblog.com/wp-content/plugins/tinymce-advanced/mce/searchreplace/editor_plugin.js");
tinymce.PluginManager.load("xhtmlxtras", "http://www.burgoblog.com/wp-content/plugins/tinymce-advanced/mce/xhtmlxtras/editor_plugin.js");
tinymce.PluginManager.load("advlink", "http://www.burgoblog.com/wp-content/plugins/tinymce-advanced/mce/advlink/editor_plugin.js");
tinymce.PluginManager.load("advimage", "http://www.burgoblog.com/wp-content/plugins/tinymce-advanced/mce/advimage/editor_plugin.js");
tinyMCE.init({mode:"none",onpageload:"wpEditorInit",width:"100%",theme:"advanced",skin:"wp_theme",theme_advanced_buttons1:"bold,italic,strikethrough,underline,separator,bullist,numlist,outdent,indent,separator,justifyleft,justifycenter,justifyright,separator,link,unlink,separator,image,styleprops,separator,wp_more,wp_page,separator,spellchecker,search,separator,fullscreen,wp_adv",theme_advanced_buttons2:"pastetext,pasteword,removeformat,separator,charmap,print,separator,forecolor,emotions,separator,sup,sub,media,separator,undo,redo,attribs,wp_help",theme_advanced_buttons3:"blockquote,cut,copy,paste,fontselect,styleselect,fontsizeselect,formatselect,cite",theme_advanced_buttons4:"",language:"en",spellchecker_languages:"+English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv",theme_advanced_toolbar_location:"top",theme_advanced_toolbar_align:"left",theme_advanced_statusbar_location:"bottom",theme_advanced_resizing:"1",theme_advanced_resize_horizontal:"",dialog_type:"modal",relative_urls:"",remove_script_host:"",convert_urls:"",apply_source_formatting:"",remove_linebreaks:"1",paste_convert_middot_lists:"1",paste_remove_spans:"1",paste_remove_styles:"1",gecko_spellcheck:"1",entities:"38,amp,60,lt,62,gt",accessibility_focus:"",tab_focus:":next",content_css:"http://www.burgoblog.com/wp-includes/js/tinymce/wordpress.css,http://www.burgoblog.com/wp-content/plugins/tinymce-advanced/css/tadv-mce.css",save_callback:"switchEditors.saveCallback",wpeditimage_disable_captions:"",plugins:"safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage,-style,-emotions,-print,-searchreplace,-xhtmlxtras,-advlink,-advimage",wordpress_adv_toolbar:"toolbar2"});